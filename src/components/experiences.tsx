...
const Experiences = () => {
  return (
   <div className="flex flex-col-reverse gap-8 lg:flex-row items-start lg:items-center lg:gap-16 mx-5 md:mx-10 lg:mx-auto max-w-6xl w-full py-8 lg:py-0">
    <div className="relative flex flex-col items-start lg:items-center">
     <span className="text-xl lg:text-2xl text-white mb-2">
    ...
    <div className="relative flex flex-col items-start pl-2 sm:pl-4 md:pl-6 w-full">
     <div className="relative pl-6 sm:pl-8 w-full">
      {experiences.map((experience, index) => (
       ...
       >
        {/* Vertical Line */}
        <motion.div
         className="absolute left-[-20px] sm:left-[-24px] w-[2px] bg-theme-primary"
         initial={{ height: 0 }}
         animate={{
          height: '100%',
         }}
